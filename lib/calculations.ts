...
export const calculate_adoption = (cover_crop_acres: number, total_field_acreage: number) => {
  const proportion = cover_crop_acres / total_field_acreage
  return proportion * 100
}

/** Calculate greenhouse gas emissions per acre */
export const calculate_emissions = (ghg_kg: number, total_field_acreage: number) => {
